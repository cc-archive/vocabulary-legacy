          ...
          <div class="columns">
            <div class="column is-full">
              <nav aria-label="footerlinks" class="footer-navigation">
                <ul class="menu">
                  <li><a href="https://github.com/creativecommons/vocabulary/releases" class="menu-item" rel="noopener">Release Notes</a></li>
          ...
          <div class="columns">
            ...
            <div class="column is-one-third">
              <aside class="donate-section">
                ...
                <a class="button small donate" href="http://creativecommons.org/donate" rel="noopener">

      ...
      <article class="card entry-post entry-quote horizontal no-border">
        <header class="card-image">
          <figure class="image is-1by1">
            <img src="https://picsum.photos/id/433/96/96" alt="Header image"></img>
          </figure>
        </header>
        <div class="card-content">
        ...
        <header class="card-image">
          <a href="#">
            <figure class="image is-4by5">
              <img src="https://picsum.photos/id/433/350/370" alt="Header image"></img>
            </figure>
          </a>
        </header>
        <div class="card-content">
      ...
      <article class="card entry-post horizontal no-border blog-entry">
        <header>
          <figure class="image blog-image">
            <img class="profile" src="demo/lion_dafrique.jpg"></img>
          </figure>
        </header>

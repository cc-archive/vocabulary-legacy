...
<IconGallery>
  {Object.entries(iconGroups.arrows.chevrons).map(([name, svg]) => (
...
<IconGallery>
  {Object.entries(iconGroups.arrows.angles).map(([name, svg]) => (
    <IconItem key={name} name={name}>
      <div
        style={{ height: "16px", width: "16px" }}
        dangerouslySetInnerHTML={{ __html: svg }}
...
<IconGallery>
  {Object.entries(iconGroups.arrows.carets).map(([name, svg]) => (
    <IconItem key={name} name={name}>
      <div
        style={{ height: "16px", width: "16px" }}
        dangerouslySetInnerHTML={{ __html: svg }}
...
<IconGallery>
  {Object.entries(iconGroups.symbols.shapes).map(([name, svg]) => (
    <IconItem key={name} name={name}>
      <div
        style={{ height: "16px", width: "16px" }}
        dangerouslySetInnerHTML={{ __html: svg }}
...
<IconGallery>
  {Object.entries(iconGroups.symbols.hieroglyphs).map(([name, svg]) => (
    <IconItem key={name} name={name}>
      <div
        style={{ height: "16px", width: "16px" }}
        dangerouslySetInnerHTML={{ __html: svg }}
...
<IconGallery>
  {Object.entries(iconGroups["social-media"]).map(([name, svg]) => (
    <IconItem key={name} name={name}>
      <div
        style={{ height: "16px", width: "16px" }}
        dangerouslySetInnerHTML={{ __html: svg }}

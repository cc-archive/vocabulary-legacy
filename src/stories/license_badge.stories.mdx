...
<Preview
  mdxSource={[licenseSVG('big', 'by'), licenseSVG('small', 'by')].join('\n\n')}
>
  <Story
    name="BY"
    height="96px"
...
<Preview
  mdxSource={[licenseSVG('big', 'by_sa'), licenseSVG('small', 'by_sa')].join(
    '\n\n'
  )}
>
  <Story
...
<Preview
  mdxSource={[licenseSVG('small', 'by_nd'), licenseSVG('big', 'by_nd')].join(
    '\n\n'
  )}
>
  <Story

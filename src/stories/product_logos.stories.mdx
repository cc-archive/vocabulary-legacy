...
<Preview mdxSource={blackText(certificatesSvg)}>
  <Story name="Certificates" height="128px" parameters={{
...
<Preview mdxSource={blackText(chooserSvg)}>
  <Story name="Chooser" height="128px" parameters={{
    design: figmaConfig('784%3A1')
  }}>{
...
<Preview mdxSource={blackText(globalNetworkSvg)}>
  <Story name="Global Network" height="128px" parameters={{
    design: figmaConfig('784%3A1')
  }}>{
...
<Preview mdxSource={blackText(globalSummitSvg)}>
  <Story name="Global Summit" height="128px" parameters={{
    design: figmaConfig('784%3A1')
  }}>{
...
<Preview mdxSource={blackText(legalDatabaseSvg)}>
  <Story name="Legal Database" height="128px" parameters={{
...
<Preview mdxSource={blackText(openSourceSvg)}>
  <Story name="Open Source" height="128px" parameters={{
    design: figmaConfig('784%3A1')
  }}>{
...
<Preview mdxSource={blackText(searchSvg)}>
  <Story name="Search" height="128px" parameters={{
    design: figmaConfig('784%3A1')
  }}>{
    blackText(searchSvg)
  }</Story>
...
<Preview mdxSource={blackText(stateOfTheCommonsSvg)}>
  <Story name="State of the Commons" height="128px" parameters={{
    design: figmaConfig('784%3A1')
  }}>{
...
<Preview mdxSource={blackText(vocabularySvg)}>
  <Story name="Vocabulary" height="96px" parameters={{
    design: figmaConfig('784%3A1')
  }}>{

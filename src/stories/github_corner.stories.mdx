...
<Preview>
  <Story name="Normal" height="100px">{`
...
<Preview>
  <Story name="Left aligned" height="100px">{`
...
<Story name="Figma" parameters={{
  design: config({
    type: 'figma',
    url: 'https://www.figma.com/file/l4Mt3dn3Ndtrvrb4aLcwXI/Design-Library?node-id=795%3A1'
  })
}}>
</Story>

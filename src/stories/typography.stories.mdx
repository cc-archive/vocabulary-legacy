...
<Preview>
  <Story name="Heading 1A" height="100px">{typeAContent(1)}</Story>
</Preview>
...
<Preview>
  <Story name="Heading 2A" height="100px">{typeAContent(2)}</Story>
</Preview>
...
<Preview>
  <Story name="Heading 3A" height="100px">{typeAContent(3)}</Story>
</Preview>
...
<Preview>
  <Story name="Heading 4A" height="100px">{typeAContent(4)}</Story>
</Preview>
...
<Preview>
  <Story name="Heading 5A" height="100px">{typeAContent(5)}</Story>
</Preview>
...
<Preview>
  <Story name="Value" height="100px">{`<p class="value">000</p>`}</Story>
</Preview>
...
<Preview>
  <Story name="Heading 3B" height="100px">{typeBContent(3)}</Story>
</Preview>
...
<Preview>
  <Story name="Heading 4B" height="100px">{typeBContent(4)}</Story>
</Preview>
...
<Preview>
  <Story name="Heading 5B" height="100px">{typeBContent(5)}</Story>
</Preview>
...
export const textContent = (size) => `<p class="text-${size.toLowerCase()}">Body ${size}</p>`

<Preview>
  <Story name="Body Bigger" height="100px">{textContent('Bigger')}</Story>
</Preview>
...
<Preview>
  <Story name="Body Big" height="100px">{textContent('Big')}</Story>
</Preview>
...
<Preview>
  <Story name="Body Normal" height="100px">{textContent('Normal')}</Story>
</Preview>
...
<Preview>
  <Story name="List" height="100px">{textContent('Normal')}</Story>
</Preview>
...
<Preview>
  <Story name="Caption" height="100px">{textContent('Small')}</Story>
</Preview>

...
<Preview
  mdxSource={whiteText(logomarkSvg)}
  style={{ backgroundColor: 'black' }}
>
  <Story
    name="Logomark Inverted"
    height="128px"
    parameters={{
...
The CC lettermark and the CC "letterheart" can also found as icons for easier
embedding in other components, like buttons for example.

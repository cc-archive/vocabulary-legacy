...
The icon for CC Lettermark and Letterheart can also found under icons for embedding in other places like buttons

export const lettermarkSvg = `<style>svg { height: 72px; }</style>
${svgCode(72, 72, 'cc/lettermark', 'lettermark')}
<p>The icon for CC Lettermark can also found under icons for embedding in other places like buttons</p>`
...
export const letterheartSvg = `<style>svg { height: 72px; }</style>
${svgCode(80, 72, 'cc/letterheart', 'letterheart')}
<p>The icon for CC Letterheart can also found under icons for embedding in other places like buttons</p>`

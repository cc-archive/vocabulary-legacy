...
export const cardWithButton = (width, image_size, orientation) =>
  `<div style="max-width: ${width}px;">
  <article class="card entry-post ${orientation}">
    <header class="card-image">
      <figure class="image is-${image_size}">
        <img src="https://picsum.photos/id/433/700/392" alt="Header image"></img>
      </figure>
    </header>

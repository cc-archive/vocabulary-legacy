...
import Header from '@/patterns/Header/Header.vue'
import HeaderSmall from '@/patterns/Header/HeaderSmall.vue'

<Meta title="Patterns|Header" component={ Header } />

# Header
Header is a multi-component which uses 
- Logo component
- Navigation component

<Story name="Header" inline>{{
components: { Header },
template: `
    <Header/>
`
...
Tight version of the Header component

<Story name="HeaderSmall" inline>{{

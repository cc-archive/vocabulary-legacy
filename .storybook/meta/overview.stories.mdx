...
#### Meaning
- If there’s a new design element needed for a website, CC’s UX designer needs to be consulted and create a design in
  Figma first.
...
- Figma should clearly separate the styles of basic elements and patterns from documentation on how those elements and
  ...
  - For example, Figma should offer colors as elements in the Design Library, but the way to use those colors well
    should go in a documentation section.
...
- Kriti, at her discretion, consults with Breno, Hugo, and/or Dhruv and makes a decision and communicates it on the
  GitHub ticket

...
<p class="subtitle is-5">Subtitle 6</p>
`

Headings of type A need no additional classes to be used. They directly apply to all heading tags from `<h1>` to `<h6>`.

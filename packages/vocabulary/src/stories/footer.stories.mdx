...
<footer class="footer">
  ...
  <aside class="column donate-section">
    ...
    <a class="button small donate" href="http://creativecommons.org/donate">
      <i class="icon cc-letterheart-filled margin-right-small is-size-4 padding-top-smaller"></i>
      Donate now
    </a>
  </aside>
  <div class="column footer-logo">
    ...
    <div class="margin-vertical-normal">
      ...
      <a href="https://www.linkedin.com/company/creative-commons/" aria-label="linkedin" class="social has-text-white" target="_blank" rel="noopener">
        <i class="icon margin-right-normal is-size-2">linkedin</i>
      </a>
    </div>
  </div>
